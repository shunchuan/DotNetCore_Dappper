...
namespace DotNetCore_Dappper.Infrastructure.Untity
{
    public static class SecretUntity
    {
        #region MD5 加密
        /// <summary>
        /// MD5加密
        ...
        ///// <summary>
        ///// HmacRipeMd160 加密 //仅支持.NET Framework ,不支持.NET Core
        ///// </summary>
        ...
        //密钥对，请配合密钥生成工具使用『 [url]http://download.csdn.net/detail/downiis6/9464639[/url] 』
